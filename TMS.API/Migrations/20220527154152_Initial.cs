    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1144), ".NET", null, null, false },
                    { 2, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1154), "JAVA", null, null, false },
                    { 3, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1158), "LAMP", null, null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1263), "Assigned", null, null },
                    { 2, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1269), "Completed", null, null },
                    { 3, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(1273), "Canceled", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(255), "Training Head", null, null, false },
                    { 2, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(293), "Training Coordinator", null, null, false },
                    { 3, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(298), "Trainer", null, null, false },
                    { 4, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(302), "Trainee", null, null, false },
                    { 5, 0, new DateTime(2022, 5, 27, 21, 11, 50, 891, DateTimeKind.Local).AddTicks(306), "Reviewer", null, null, false }
                });
