    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8691), ".NET", null, null, false },
                    { 2, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8693), "JAVA", null, null, false },
                    { 3, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8695), "LAMP", null, null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8715), "Assigned", null, null },
                    { 2, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8716), "Completed", null, null },
                    { 3, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8717), "Canceled", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8493), "Training Head", null, null, false },
                    { 2, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8506), "Training Coordinator", null, null, false },
                    { 3, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8508), "Trainer", null, null, false },
                    { 4, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8509), "Trainee", null, null, false },
                    { 5, 0, new DateTime(2022, 7, 25, 9, 30, 19, 249, DateTimeKind.Local).AddTicks(8510), "Reviewer", null, null, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "sera@gmail.com", "TMS101", "Sera", null, "6c7nGrky/ehjM40Ivk3p3+OeoEm9r7NCzmWexUULaa4=", 1, null, null, "Sera", false });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Base64", "CreatedBy", "CreatedOn", "DepartmentId", "Email", "EmployeeId", "FullName", "Image", "Password", "RoleId", "UpdatedBy", "UpdatedOn", "UserName", "isDisabled" },
                values: new object[] { 2, "", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "sally@gmail.com", "TMS201", "Sally", null, "6c7nGrky/ehjM40Ivk3p3+OeoEm9r7NCzmWexUULaa4=", 2, null, null, "Sally", false });
