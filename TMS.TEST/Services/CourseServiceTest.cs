...
namespace TMS.TEST.Services
{
    public class CourseServiceTest
    {
        ...
        public CourseServiceTest(ILogger<CourseService> logger)
        {
            _courseService = new CourseService(_unitOfWork.Object, logger);
        ...
        public void CreateTopic()
        {
            ...
            var Result = _courseService.CreateTopic(_topic,1);
        ...
        public void GetCourseById()
        {
            ...
            var Result = _courseService.GetCourseById(courseId,1);
        ...
        public void CreateCourse()
        {
            ...
            var Result = _courseService.CreateCourse(_course,1);
            Assert.Equal(result, Result);
        }
        [Fact]
        public void UpdateCourse()
        {
            ...
            _unitOfWork.Setup(obj => obj.Validation.CourseExists(courseId)).Returns(true);
            _unitOfWork.Setup(obj => obj.Courses.GetCourseById(courseId)).Returns(_course);
            var Result = _courseService.UpdateCourse(_course,1);
            Assert.Equal(result, Result);
        }
        [Fact]
